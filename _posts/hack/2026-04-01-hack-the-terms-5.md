...
웹 프론트엔드 개발의 최전선에 위치하는 작업이 HTML과 CSS를 사용해 UI의 뼈와 살을 구축하는 일일 것이다. 국내에선 보통 퍼블리싱이라는 표현을 사용해 구분짓는데 이쪽도 엄연히 프론트엔드 개발의 중요한 한 축이다. 개인적으론 FE 개발 중에서도 제일 어려워 하는 부분이기도 하고. 아무튼 앞서 설명한 사용례에서 알 수 있듯 요소 탭은 퍼블리싱 작업에 있어서 가장 직접적인 도움을 주는 기능이라고 볼 수 있다.
