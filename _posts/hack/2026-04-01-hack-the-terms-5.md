...
요소 탭에서 보여주는 결과물은 페이지를 구성하는 HTML 코드 형태로 나타나며, <a href="/hack/4/rendering-in-web#중요-렌더링-경로critical-rendering-path">HTML을 해석해 도출한 DOM</a>을 확인하고 조작하는 기능을 제공하는 영역이라고 볼 수 있다. 따라서서 아래와 같은 동작이 가능하다.
