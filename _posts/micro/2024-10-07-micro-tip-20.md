...
<p class="center">
  Postimage.org 점검으로 인해 이미지 업로드 보류 중
</p>
...
가난한 개발자는 커피 마실 돈이 필요해요. 하지만 글쏨씨가 미려하지도 않고, 기술적으로 아주 깊은 통찰을 보여주지도 않는데다 창의성도 부족한 이 블로그에서 저 버튼을 기꺼이 누를 사람이 얼마나 있을까. 버튼에 눈길이라도 한 번 주십사 재롱을 좀 부려봤다. 여전히 마감은 마음에 들지 않는다.
